...
function DateCalendar({ selected, onSelect }: { selected: string; onSelect: (d: string) => void }) {
 ...
 return (
 <div className="rounded-2xl border border-[#e4e5e1] dark:border-[#2d3b36] bg-[#faf9f5] dark:bg-[#0f1412] dark:bg-[#151e1b] p-4">
 {/* month nav */}
 <div className="flex items-center justify-between mb-3">
 <button
 type="button"
 onClick={() => setMonthOffset((p) => p - 1)}
 className="rounded-lg border border-[#e4e5e1] dark:border-[#2d3b36] px-2.5 py-1 text-xs text-[#5a615c] dark:text-[#9ca3af] hover:border-[#b9b5a5] dark:hover:border-[#4a5a52] dark:hover:border-[#4a5a52] hover:text-[#141613] dark:hover:text-[#f0eeea] dark:hover:text-[#e8e6e0] transition"
 >
 ← 上月
 </button>
 ...
 isSelected ?"bg-[#1f5e4b] dark:bg-[#166534] text-white" :
 isToday ?"border border-[#1f5e4b] dark:border-[#4ade80] bg-[#f0f6f4] dark:bg-[#1e2b27] text-[#1f5e4b] dark:text-[#4ade80]" :"hover:bg-[#f0f6f4] dark:hover:bg-[#1e2b27] dark:hover:bg-[#1e2b27] text-[#5a615c] dark:text-[#9ca3af]"
 }`}
 >
